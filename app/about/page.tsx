...
export const metadata: Metadata = {
  title: "About",
  description: `Learn more about ${siteConfig.name}, an MS Economics student at Texas A&M specializing in data analytics, applied economics, and ML.`,
};
...
const skills = {
  ...
  "Frontend": ["React Native", "Expo", "Next.js", "Tailwind"],
};
              ...
              <div className="rounded-2xl bg-gray-900 p-8 border border-gray-800">
                ...
                <div className="space-y-4 text-gray-400 leading-relaxed">
                  <p>
                    ...
                    analytics dashboards, developing ML pipelines for agricultural research, and
              ...
              <div className="rounded-2xl bg-gradient-to-br from-brand-600 to-brand-700 p-6 text-white">
                ...
                <div className="space-y-2">
                  <a
                    ...
                    className="flex items-center gap-2 text-sm text-brand-100 hover:text-white transition-colors"
                  >
